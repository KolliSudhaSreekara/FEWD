...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const categoryDiscounts = [
        { category: 'Electronics', discount: '10% off', image: 'electronics.jpg' },
        { category: 'Clothing', discount: '15% off', image: 'clothing.jpg' },
        { category: 'Home & Kitchen', discount: '20% off', image: 'home_kitchen.jpg' }
    ];
